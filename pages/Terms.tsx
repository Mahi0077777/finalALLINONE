...
const Terms: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-16">
      <SEO 
        title="Terms of Use - FreePDFPro"
        description="Terms of Service for using FreePDFPro's online PDF tools."
      />
      ...
      <div className="prose dark:prose-invert max-w-none bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700">
        ...
        <p>
          By accessing and using FreePDFPro, you accept and agree to be bound by the terms and provision of this agreement.
        </p>

        <h3>2. Description of Service</h3>
        <p>
          FreePDFPro provides free online PDF tools. The service is provided "as is" and "as available". 
          We modify files locally in your browser.
        </p>

        <h3>3. Limitation of Liability</h3>
        <p>
          In no event shall FreePDFPro be liable for any damages (including, without limitation, damages for loss of data or profit) 
