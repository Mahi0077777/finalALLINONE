...
const schemaTemplates = {
  ...
  'jpg-to-pdf': {
    breadcrumb: { position: 2, name: 'JPG to PDF', url: 'https://freepropdf.com/jpg-to-pdf' },
    howTo: {
      name: 'How to Convert JPG to PDF',
      description: 'Step-by-step guide to convert JPG images to PDF files using FreeProPDF\'s online converter',
      image: 'https://freepropdf.com/images/jpg-to-pdf.jpg',
      totalTime: 'PT2M',
      steps: ['Upload JPG Images', 'Arrange Image Order', 'Download PDF File']
    },
    faq: [
      { question: 'Can I convert multiple JPGs?', answer: 'Yes, you can convert multiple JPG images into a single PDF file.' },
      { question: 'What resolution should JPGs be?', answer: 'For PDF conversion, use original JPG resolution for best quality preservation.' },
      { question: 'Can I arrange images in PDF?', answer: 'Yes, our tool allows you to drag and drop images into the perfect order before conversion.' }
    ]
  },
  'rotate-pdf': {
...
// List of all SEO pages to process
const seoPages = [
  // Remaining Merge PDF pages
  'merge-pdf-for-mobile',
  'merge-pdf-for-printing', 
  'merge-pdf-for-resumes',
  
  // Core Merge PDF pages
...
console.log('Schema markup added to all SEO pages!');
